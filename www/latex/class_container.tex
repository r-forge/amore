...
\begin{center}
\leavevmode
\includegraphics[width=294pt]{class_container_ae763eb37b721d401327c97016fb2fa54_cgraph}
\end{center}
\end{figure}
...
{       return ldata.end(); }
\end{DoxyCode}
\hypertarget{class_container_a6fb8ecb9656c1732dbbc8d5a8a98f14d}{
\index{Container@{Container}!getLdata@{getLdata}}
\index{getLdata@{getLdata}!Container@{Container}}
\subsubsection[{getLdata}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T $>$ std::vector$<$ boost::shared\_\-ptr$<$ T $>$ $>$ {\bf Container}$<$ T $>$::getLdata (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}
\label{class_container_a6fb8ecb9656c1732dbbc8d5a8a98f14d}
...
\begin{DoxySeeAlso}{See also}
\hyperlink{class_container_a9ba632f4fc005eca7a7cb4c7616a7796}{setLdata} and the unit test files, e.g., runit.Cpp.Container.R, for usage examples. 
\end{DoxySeeAlso}
...
\end{DoxyCode}
\hypertarget{class_container_a9ba632f4fc005eca7a7cb4c7616a7796}{
\index{Container@{Container}!setLdata@{setLdata}}
\index{setLdata@{setLdata}!Container@{Container}}
\subsubsection[{setLdata}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T$>$ void {\bf Container}$<$ T $>$::setLdata (
\begin{DoxyParamCaption}
\item[{typename std::vector$<$ boost::shared\_\-ptr$<$ T $>$ $>$}]{v}
\end{DoxyParamCaption}
)}}
\label{class_container_a9ba632f4fc005eca7a7cb4c7616a7796}
...
\end{DoxyParams}
\begin{DoxySeeAlso}{See also}
\hyperlink{class_container_a6fb8ecb9656c1732dbbc8d5a8a98f14d}{getLdata} and the unit test files, e.g., runit.Cpp.Container.R, for usage examples. 
\end{DoxySeeAlso}
