...
\begin{center}
\leavevmode
\includegraphics[width=214pt]{class_radial_basis__inherit__graph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=214pt]{class_radial_basis__coll__graph}
\end{center}
\end{figure}
...
\item 
pkg/AMORE/src/dia/\hyperlink{_radial_basis_8h}{RadialBasis.h}\end{DoxyCompactItemize}
