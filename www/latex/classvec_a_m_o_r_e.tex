...
\index{vecAMORE@{vecAMORE}!reserve@{reserve}}
\index{reserve@{reserve}!vecAMORE@{vecAMORE}}
\subsubsection[{reserve}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T $>$ void {\bf vecAMORE}$<$ T $>$::reserve (
\begin{DoxyParamCaption}
\item[{int}]{n}
\end{DoxyParamCaption}
)}}
...
Definition at line 239 of file vecAMORE.cpp.
