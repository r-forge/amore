...
\begin{DoxySeeAlso}{See also}
\hyperlink{classvec_a_m_o_r_e_ad1594c084d534c3de7acedd714f2e12a}{Container::setLdata} , \hyperlink{classvec_a_m_o_r_e_a7b02ec757039b4d8fa98c3682002f156}{Container::push\_\-back} and the unit test files, e.g., runit.Cpp.Container.R, for usage examples. 
\end{DoxySeeAlso}
...
\begin{DoxyCode}
      ...
      ().at(i), weights[i]) );
                ...
                // Test
                        ...
                        for (int i=0; i<=2 ; i++) {                                     /
      / get Ids. Container does not have getFromId defined
...
\begin{DoxySeeAlso}{See also}
\hyperlink{classvec_a_m_o_r_e_ad1594c084d534c3de7acedd714f2e12a}{setLdata} and the unit test files, e.g., runit.Cpp.Container.R, for usage examples. 
\end{DoxySeeAlso}
...
\end{DoxyParams}
\begin{DoxySeeAlso}{See also}
\hyperlink{classvec_a_m_o_r_e_aeabf8a479f9031cc8ef9af0a971a08ea}{getLdata} and the unit test files, e.g., runit.Cpp.Container.R, for usage examples. 
\end{DoxySeeAlso}
