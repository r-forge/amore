...
\item 
\hyperlink{class_con_container_a69e83fdaf298e23758fe7ead2fe488b9}{ConContainer} (std::vector$<$ \hyperlink{_a_m_o_r_e_8h_aec013d6637f08d6d33ffa90a4c802b9a}{ConPtr} $>$ \hyperlink{class_container_a80e0663ccf6d358b15d0064d855a8e7b}{collection})
\item 
...
\begin{center}
\leavevmode
\includegraphics[width=348pt]{class_con_container_a9665acde2f526ae4207b919c90615fe5_cgraph}
\end{center}
\end{figure}
...
\subsubsection[{select}]{\setlength{\rightskip}{0pt plus 5cm}{\bf ConContainerPtr} ConContainer::select (
\begin{DoxyParamCaption}
\item[{std::vector$<$ int $>$}]{nIds}
\end{DoxyParamCaption}
)}}
