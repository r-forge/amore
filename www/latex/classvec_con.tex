...
void \hyperlink{classvec_con_a43000d3bd790425722ed5e7939aeeae0}{setFromNeuron} (std::vector$<$ \hyperlink{_a_m_o_r_e_8h_a03051950b0faf9499d14cf376e04c329}{NeuronSharedPtr} $>$ FROM)
...
Definition at line 291 of file vecCon.cpp.
...
\hypertarget{classvec_con_a43000d3bd790425722ed5e7939aeeae0}{
\index{vecCon@{vecCon}!setFromNeuron@{setFromNeuron}}
\index{setFromNeuron@{setFromNeuron}!vecCon@{vecCon}}
\subsubsection[{setFromNeuron}]{\setlength{\rightskip}{0pt plus 5cm}void vecCon::setFromNeuron (
\begin{DoxyParamCaption}
\item[{std::vector$<$ {\bf NeuronSharedPtr} $>$}]{FROM}
\end{DoxyParamCaption}
)}}
\label{classvec_con_a43000d3bd790425722ed5e7939aeeae0}
...
Definition at line 238 of file vecCon.cpp.
...
\begin{DoxyCode}
                                            {
        BEGIN_RCPP
        if (w.empty()) { throw std::range_error("[ C++ vecCon::setWeight]: Error,
       w is empty"); }
        if (w.size() != ldata.size() ) { throw std::range_error("[C++ vecCon::set
      Weight]: Error, w.size() != ldata.size()"); }
