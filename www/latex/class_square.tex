...
\begin{center}
\leavevmode
\includegraphics[width=214pt]{class_square__inherit__graph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=214pt]{class_square__coll__graph}
\end{center}
\end{figure}
...
\item 
pkg/AMORE/src/dia/\hyperlink{_square_8h}{Square.h}\end{DoxyCompactItemize}
