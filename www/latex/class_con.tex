...
\hyperlink{class_con_ad0b1e0d1eefd2296b23a2cfea04fc559}{Con} (\hyperlink{class_neuron}{Neuron} \&neuron, double \hyperlink{class_con_a73953750d4503346ed1ba83fdd82f016}{weight})
\begin{DoxyCompactList}\small\item\em Constructor. \end{DoxyCompactList}\item 
\hyperlink{class_neuron}{Neuron} \& \hyperlink{class_con_abf5ebf50b0357f418adb6d9fd6d671f1}{neuron} ()
\begin{DoxyCompactList}\small\item\em from field accessor. \end{DoxyCompactList}\item 
int \hyperlink{class_con_aee0a0b6c5beff6e227f9ebf33af2d209}{Id} ()
...
double \& \hyperlink{class_con_a96b1b0389be5f86d706ac9baf8fe5c49}{weight} ()
\item 
...
double \hyperlink{class_con_a73953750d4503346ed1ba83fdd82f016}{weight}
...
The \hyperlink{class_con}{Con} class provides a simple class for a connection described by a pair of values: a pointer to a \hyperlink{class_neuron}{Neuron} object used as the \hyperlink{class_con_a7c05f90dff56fd26c1fa0f042bba67a6}{from} field and the \hyperlink{class_con_a73953750d4503346ed1ba83fdd82f016}{weight} used to propagate the value of that \hyperlink{class_neuron}{Neuron} object. 
...
This method allows access to the value stored in the private field \hyperlink{class_con_a73953750d4503346ed1ba83fdd82f016}{weight} \begin{DoxyReturn}{Returns}
The value of \hyperlink{class_con_a73953750d4503346ed1ba83fdd82f016}{weight} (double)
\end{DoxyReturn}
...
\begin{DoxySeeAlso}{See also}
\hyperlink{class_con_ad5c1a25a2ded72999bf5293f5e55d7d9}{setWeight} and the unit test files, e.g., runit.Cpp.Con.R, for further examples. 
\end{DoxySeeAlso}
...
\begin{center}
\leavevmode
\includegraphics[width=280pt]{class_con_a385c5bf6eb9e2ffc94c5b427c287ccb2_cgraph}
\end{center}
\end{figure}
...
Definition at line 79 of file Con.cpp.
...
\hypertarget{class_con_abf5ebf50b0357f418adb6d9fd6d671f1}{
\index{Con@{Con}!neuron@{neuron}}
\index{neuron@{neuron}!Con@{Con}}
\subsubsection[{neuron}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Neuron} \& Con::neuron (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}
\label{class_con_abf5ebf50b0357f418adb6d9fd6d671f1}
...
Definition at line 54 of file Con.cpp.
...
This method sets the value of the \hyperlink{class_con_a73953750d4503346ed1ba83fdd82f016}{weight} field. 
\begin{DoxyParams}{Parameters}
{\em w} & The new value (double) to be set in the \hyperlink{class_con_a73953750d4503346ed1ba83fdd82f016}{weight} field.\\
\hline
\end{DoxyParams}
...
\begin{center}
\leavevmode
\includegraphics[width=280pt]{class_con_ad5c1a25a2ded72999bf5293f5e55d7d9_cgraph}
\end{center}
\end{figure}
...
\end{DoxyReturn}
\begin{DoxySeeAlso}{See also}
\hyperlink{class_con_ad5c1a25a2ded72999bf5293f5e55d7d9}{setWeight} and the unit test files, e.g., runit.Cpp.Con.R, for usage examples. 
\end{DoxySeeAlso}
...
\begin{center}
\leavevmode
\includegraphics[width=232pt]{class_con_ab85838575b5e01f3b8073136f2102922_cgraph}
\end{center}
\end{figure}
...
Definition at line 138 of file Con.cpp.



References Id(), and weight().
...
\begin{center}
\leavevmode
\includegraphics[width=268pt]{class_con_af5f836a7b0988b3d9113589b2959d5e6_cgraph}
\end{center}
\end{figure}
...
\label{class_con_af5f836a7b0988b3d9113589b2959d5e6}
\hypertarget{class_con_a96b1b0389be5f86d706ac9baf8fe5c49}{
...
\label{class_con_a96b1b0389be5f86d706ac9baf8fe5c49}


Referenced by getWeight(), setWeight(), and validate().
...
\begin{center}
\leavevmode
\includegraphics[width=280pt]{class_con_a96b1b0389be5f86d706ac9baf8fe5c49_icgraph}
\end{center}
\end{figure}
...
\subsubsection[{d\_\-neuron}]{\setlength{\rightskip}{0pt plus 5cm}{\bf NeuronRef} {\bf Con::d\_\-neuron}\hspace{0.3cm}{\ttfamily  \mbox{[}protected\mbox{]}}}}
...
\subsubsection[{d\_\-weight}]{\setlength{\rightskip}{0pt plus 5cm}double {\bf Con::d\_\-weight}\hspace{0.3cm}{\ttfamily  \mbox{[}protected\mbox{]}}}}
...
The \hyperlink{class_con_a73953750d4503346ed1ba83fdd82f016}{weight} field contains the factor by which the output value of the \hyperlink{class_neuron}{Neuron} addressed by the from field is multiplied during simulation or training.
