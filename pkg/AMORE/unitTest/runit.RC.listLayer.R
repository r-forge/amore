...
test.gListLayer.new_fromIsNeuron <- function() {	
	nl1 <- gmlpLayer$new(activationFunction="tanh")  # buildAndAppend will set the value of numberOfNeurons
	nl1$buildAndAppend(ID=c(1,2,3,4,5), BIAS=c(1.1,3.4,5.4,9.8,5.6), FROM=list(1:3,4:6,7:9,10:12,13:15), WEIGHT=list(11:13,21:23,31:33,41:43,51:53))
