...
test.gListNeuron.getId_fromIsNumeric <- function() {
	lc <- gListCon$new()
	lc$buildAndAppend(FROM=1:5, WEIGHT=11:15)
	nn <- gNeuron$new(id=1, con=lc)
	ln <- gListNeuron$new()
	...
	ln$push_back(nn)
	checkTrue(ln$validate())
	checkEquals(ln$getConId(),list(1:5,1:5, 1:5))
	checkEquals(ln$getFrom(ID=2:3),list(1:5, 1:5))
	checkEquals(ln$getConId(ID=2:3),list(1:5, 1:5))
}


test.gListNeuron.getId_fromIsNeuron <- function() {
	lc <- gListCon$new()
	lc$buildAndAppend(FROM=1:5, WEIGHT=11:15)
	nn <- gNeuron$new(id=1, con=lc)
	ln <- gListNeuron$new()
	...
	ln2 <- gListNeuron$new()
	lc <- gListCon$new()
	lc$buildAndAppend(FROM=ln$getLdata(), WEIGHT=31:33)
	nn <- gNeuron$new(id=4, con=lc)
	ln2$push_back(nn)
	lc <- gListCon$new()
	lc$buildAndAppend(FROM=ln$getLdata(), WEIGHT=41:43)
	...
	checkEquals(ln2$getConId(),list(1:3,1:3, 1:3))
	checkEquals(ln2$getConId(ID=5:6),list(1:3, 1:3))
}
...
test.gListNeuron.is.regular <- function() {
	...
	lc <- gListCon$new()
	lc$buildAndAppend(FROM=1:7, WEIGHT=21:27)
	nn <- gNeuron$new(id=4, con=lc)
	ln$push_back(nn)
	checkTrue(!ln$is.regular())
}
